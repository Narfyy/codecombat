...
#    copyright_prefix: "Copyright"
    ...
    resource_hub: "Central de Recursos" # {change}
...
#    status_partly_expires: "Partly expires on {{date}}"
    ...
    resource_hub: "Recursos do Professor" # {change}
...
#    revoke_selected_confirm: "Are you sure you want to revoke Licenses from all selected students?"
    ...
    teacher_quest_teach_methods_step2: "Imprima o [Student Quick Start Guide](https://files.codecombat.com/docs/resources/StudentQuickStartGuide.pdf) em Recursos do Professor." # {change}
    ...
    teacher_quest_wakka_maul_100_step2: "Veja [Arena Guide](/teachers/resources/arenas) em [Resource Hub](/teachers/resources) para dicas sobre como administrar um dia de arena de sucesso." # {change}
    ...
    back_to_resource_hub: "Voltar para Recursos do Professor" # {change}
